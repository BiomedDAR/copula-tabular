...
# TRAINING DATA FILES
TRAINXLSX = "socialdata.csv" # filename containing the raw data
...
TRAINDICTXLSX = "socialdata_dict.xlsx" #filename containing the data dictionary
...
OUTPUT_GENERAL_PREFIX = "SD_1" # prefix used for all output files, e.g. EXPT_1. if not specified, set as ""
...
SAMPLING = 1 # proportion of samples to keep for training (rest will be kept as control for privacy leakage testing) (if not specified, default is 1)
LINKABILITY = False # whether to run the linkability attack
SINGLINGOUT_UNI = False # whether to run the singlingout (univariate) attack
SINGLINGOUT_MULTI = False # whether to run the singlingout (multivariate) attack
INFERENCE = False # whether to run the inference attack
PRIVACY_BATCH_N = 100 # how many repetitions (batch process). If not specified, default is 3.